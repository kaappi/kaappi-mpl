;;; MPL test suite — ported from dharmatech/mpl test.sls (SRFI 64).
;;;
;;; Test names reference Joel S. Cohen's books:
;;;   EA — Computer Algebra and Symbolic Computation: Elementary Algorithms
...
;; "MM: page 117" is omitted: it divides polynomials with Gaussian
;; integer coefficients like (2+4i), which requires exact complex
;; arithmetic. Kaappi's complex numbers are flonum-based, so the exact
